final defs = {
  "rpc": {
    ...
    "name": {"description": "Retrieves the node name", "params": [], "type": "Text"},
    "version": {"description": "Retrieves the version of the node", "params": [], "type": "Text"},
    "chain": {"description": "Retrieves the chain", "params": [], "type": "Text"},
    "chainType": {"description": "Retrieves the chain type", "params": [], "type": "ChainType"},
    "properties": {
      "description": "Get a custom set of properties as a JSON object, defined in the chain spec",
      "params": [],
      "type": "ChainProperties"
    },
    "health": {"description": "Return health status of the node", "params": [], "type": "Health"},
    "localPeerId": {
  ...
  "types": {
    ...
    "BlockWeights": {"baseBlock": "Weight", "maxBlock": "Weight", "perClass": "PerDispatchClass"},
    "ChainProperties": {
