...
Compact Function(Registry, dynamic) _compactWith(dynamic type) {
  return (Registry registry, dynamic value) => Compact(registry, type, value);
}

class Compact<T extends CompactEncodable> implements ICompact<T> {
  Registry registry;
